...
- An Azure Database for PostgreSQL (Create via [Portal](https://docs.microsoft.com/en-us/azure/postgresql/quickstart-create-server-database-portal/?WT.mc_id=pyconindia-github-cxa) or [Azure CLI](https://docs.microsoft.com/en-us/azure/postgresql/quickstart-create-server-database-azure-cli/?WT.mc_id=pyconindia-github-cxa)) 
...
1. In the [Azure portal](https://portal.azure.com/?WT.mc_id=pyconindia-github-cxa), search for and select your Azure Database for PostgreSQL server name. 
